...
export const DefaultApiFetchParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async patchnativev1beneficiaryInformation(
      body?: BeneficiaryInformationUpdateRequest,
      options: any = {}
    ): Promise<FetchArgs> {
      ...
      const needsSerialization =
        <any>'BeneficiaryInformationUpdateRequest' !== 'string' ||
     ...
     * @throws {RequiredError}
     */
    async postnativev1meculturalSurvey(
      body?: CulturalSurveyRequest,
      options: any = {}
    ): Promise<FetchArgs> {
      ...
      localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers)
      const needsSerialization =
        <any>'CulturalSurveyRequest' !== 'string' ||
        localVarRequestOptions.headers['Content-Type'] === 'application/json'
      localVarRequestOptions.body = needsSerialization ? JSON.stringify(body || {}) : body || ''
      return {
        url: url.format(localVarUrlObj),
     ...
     * @throws {RequiredError}
     */
    async postnativev1userProfiling(
      body?: UserProfilingFraudRequest,
      options: any = {}
    ): Promise<FetchArgs> {
      ...
      localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers)
      const needsSerialization =
        <any>'UserProfilingFraudRequest' !== 'string' ||
        localVarRequestOptions.headers['Content-Type'] === 'application/json'
      localVarRequestOptions.body = needsSerialization ? JSON.stringify(body || {}) : body || ''
      return {
        url: url.format(localVarUrlObj),
...
export const DefaultApiFp = function (api: DefaultApi, configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async getnativev1mefavorites(
      basePath: string,
      options?: any
    ): Promise<PaginatedFavoritesResponse> {
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).getnativev1mefavorites(options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
     ...
     * @throws {RequiredError}
     */
    async getnativev1mefavoritescount(
      basePath: string,
      options?: any
    ): Promise<FavoritesCountResponse> {
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).getnativev1mefavoritescount(options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
     ...
     * @throws {RequiredError}
     */
    async getnativev1offerreportreasons(
      basePath: string,
      options?: any
    ): Promise<OfferReportReasons> {
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).getnativev1offerreportreasons(options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
     ...
     * @throws {RequiredError}
     */
    async getnativev1offersreports(
      basePath: string,
      options?: any
    ): Promise<UserReportedOffersResponse> {
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).getnativev1offersreports(options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
     ...
     * @throws {RequiredError}
     */
    async getnativev1subcategories(
      basePath: string,
      options?: any
    ): Promise<SubcategoriesResponseModel> {
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).getnativev1subcategories(options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
    ...
    async patchnativev1beneficiaryInformation(
      ...
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).patchnativev1beneficiaryInformation(body, options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
     ...
     * @throws {RequiredError}
     */
    async postnativev1accounthasCompletedIdCheck(
      basePath: string,
      options?: any
    ): Promise<EmptyResponse> {
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).postnativev1accounthasCompletedIdCheck(options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
    ...
    async postnativev1accountsuspend(basePath: string, options?: any): Promise<EmptyResponse> {
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).postnativev1accountsuspend(options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
    ...
    async postnativev1bookings(
      basePath: string,
      body?: BookOfferRequest,
      options?: any
    ): Promise<BookOfferResponse> {
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
    ...
    async postnativev1identityDocument(basePath: string, options?: any): Promise<EmptyResponse> {
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).postnativev1identityDocument(options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
    ...
    async postnativev1meculturalSurvey(
      ...
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).postnativev1meculturalSurvey(body, options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
    ...
    async postnativev1userProfiling(
      ...
      const localVarFetchArgs = await DefaultApiFetchParamCreator(
        configuration
      ).postnativev1userProfiling(body, options)
      const response = await safeFetch(
        basePath + localVarFetchArgs.url,
        localVarFetchArgs.options,
        api
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public async patchnativev1beneficiaryInformation(
    body?: BeneficiaryInformationUpdateRequest,
    options?: any
  ) {
    const functionalApi = DefaultApiFp(this, this.configuration)
  ...
  public async postnativev1bookingsbookingIdtoggleDisplay(
    ...
    const functionalApi = DefaultApiFp(this, this.configuration)
    return functionalApi.postnativev1bookingsbookingIdtoggleDisplay(
      this.basePath,
      booking_id,
      body,
      options
  ...
  public async postnativev1sendOfferWebappLinkByEmailofferId(offer_id: number, options?: any) {
    const functionalApi = DefaultApiFp(this, this.configuration)
    return functionalApi.postnativev1sendOfferWebappLinkByEmailofferId(
      this.basePath,
      offer_id,
      options
    )
